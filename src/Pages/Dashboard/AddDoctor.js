...
const AddDoctor = () => {
    ...
    const { data: services, isLoading } = useQuery('services', () => fetch('https://gentle-mountain-57996.herokuapp.com/service').then(res => res.json()))
        ...
        fetch(url, {
            ...
            .then(result => {
                if (result.success) {
                    ...
                    fetch(`https://gentle-mountain-57996.herokuapp.com/doctor`, {
                        method: 'POST',
                        headers: {
